...
float Get_Distance_modified(float startLatitude, float startLongitude,float endLatitude, float endLongitude)
{
		//UART_OutString("Distance\n");
    // convert all coordinates from Degrees into Radians
    float startLat = (startLatitude)* PI/180;
    float startLong = (startLongitude)* PI/180;
    float endLat = (endLatitude)* PI/180;
    float endLong = (endLongitude)* PI/180;
